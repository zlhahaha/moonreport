...
boundary. The [OSC 2026 project proposal](output/pdf/MoonReport-OSC2026-project-proposal.pdf)
is generated by `proposal/generate_proposal.py`; the
[self-review](docs/osc2026-self-review.md) records local passes and publication
gates without treating planned work as complete.
